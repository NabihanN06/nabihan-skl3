    ...
    <div class="container my-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="logout.php" class="btn btn-warning mr-2" role="button" style="background-color: red; color:white; border:0">Logout</a>
                <a href="index.php" class="btn-warning mr-2" role="button" style="background:gold; border:0; padding:1.7vh; border-radius:3px">Back to dashboard</a>
