...
<div class="container d-flex flex-column align-items-center justify-content-center w-50" style="height:90vh; background:bisque; padding:5vh;">
    <h1 class="font-weight-bold mb-5 ">Laporkan Aduanmu</h1>
    <p><?php
...
?></p>
  ...
  <div class="form-group">
    ...
    echo $messageErrorMassage;}?>
      ...
      <button type="submit" class="btn btn-primary my-2" style="background-color: red; border:0">Submit</button>
  </div>
  </div>
  </div>
